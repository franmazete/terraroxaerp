...
import type { AutorizacaoCarregamento, Carga, OrdemCarregamento, Reserva, ReservaComCarga } from "@/lib/types";
...
export function MinhasReservasClientView({ dadosSSR = null }: Props) {
